...
import { InsertUser, putUserItem } from "../../../redux/contactsRedusers";
...
const UserModal = ({title, handleClose, user, edit}) => {
    ...
    const userId = localStorage.getItem("id");
      ...
      const editContactHandler = (e) =>{
        e.preventDefault();
        dispatch(putUserItem({id, name, phone, work, userId}));
        handleClose();
      }

  return <div className={s.popup_box}>
            <div className={s.box}>
